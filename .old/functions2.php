...
class chart{ 
     ...
     */ 
    public function insertArtikel($position, $fruit, $quantity, $price, $kondition, $sum)
    { 
         
        $Artikel = array($position, $fruit, $quantity, $price, $kondition, $sum); 
    ...
    { 
        ...
        echo "<thead><th>Position</th><th>Fruit</th><th>Quantity</th><th>Preis</th><th>Kondition</th><th>Summe</th></thead>"; 
